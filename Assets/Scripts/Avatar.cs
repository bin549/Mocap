...
public class Avatar : MonoBehaviour {
    ...
    public void Initialize() {
        ...
        // Right arm.
        jointPoints[PositionIndex.RightShoulderBend.Int()].transform =
            animator.GetBoneTransform(HumanBodyBones.RightUpperArm);
        jointPoints[PositionIndex.RightForearmBend.Int()].transform =
        ...
        jointPoints[PositionIndex.RightThumb2.Int()].transform =
            animator.GetBoneTransform(HumanBodyBones.RightThumbIntermediate);
        jointPoints[PositionIndex.RightMid1.Int()].transform =
            animator.GetBoneTransform(HumanBodyBones.RightMiddleProximal);

        // Left arm.
        jointPoints[PositionIndex.LeftShoulderBend.Int()].transform =
            animator.GetBoneTransform(HumanBodyBones.LeftUpperArm);
        jointPoints[PositionIndex.LeftForearmBend.Int()].transform =
        ...
        jointPoints[PositionIndex.LeftThumb2.Int()].transform =
            animator.GetBoneTransform(HumanBodyBones.LeftThumbIntermediate);
        jointPoints[PositionIndex.LeftMid1.Int()].transform =
        ...
        // Right leg.
        jointPoints[PositionIndex.RightThighBend.Int()].transform =
        ...
        // Left leg.
        jointPoints[PositionIndex.LeftThighBend.Int()].transform =
    ...
    public void PoseUpdate() {
        ...
        float t2 = Vector3.Distance(jointPoints[PositionIndex.Neck.Int()].pos3D,
            jointPoints[PositionIndex.Spine.Int()].pos3D);
        Vector3 pm = (jointPoints[PositionIndex.RightThighBend.Int()].pos3D +
                      jointPoints[PositionIndex.LeftThighBend.Int()].pos3D) / 2f;
        float t3 = Vector3.Distance(jointPoints[PositionIndex.Spine.Int()].pos3D, pm);
        float t4r = Vector3.Distance(jointPoints[PositionIndex.RightThighBend.Int()].pos3D,
            jointPoints[PositionIndex.RightShin.Int()].pos3D);
        float t4l = Vector3.Distance(jointPoints[PositionIndex.LeftThighBend.Int()].pos3D,
            jointPoints[PositionIndex.LeftShin.Int()].pos3D);
        float t4 = (t4r + t4l) / 2f;
        float t5r = Vector3.Distance(jointPoints[PositionIndex.RightShin.Int()].pos3D,
            jointPoints[PositionIndex.RightFoot.Int()].pos3D);
        float t5l = Vector3.Distance(jointPoints[PositionIndex.LeftShin.Int()].pos3D,
            jointPoints[PositionIndex.LeftFoot.Int()].pos3D);
        float t5 = (t5r + t5l) / 2f;
        ...
        jointPoints[PositionIndex.Hip.Int()].transform.position = jointPoints[PositionIndex.Hip.Int()].pos3D * 0.005f +
                                                                  new Vector3(initPosition.x, initPosition.y,
                                                                      initPosition.z + dz);
        jointPoints[PositionIndex.Hip.Int()].transform.rotation = Quaternion.LookRotation(forward) *
        ...
        Vector3 f = TriangleNormal(jointPoints[PositionIndex.Nose.Int()].pos3D,
            jointPoints[PositionIndex.RightEar.Int()].pos3D, jointPoints[PositionIndex.LeftEar.Int()].pos3D);
        JointPoint head = jointPoints[PositionIndex.Head.Int()];
        ...
        foreach (Skeleton sk in skeletons) {
            ...
            sk.lineRenderer.SetPosition(0,
                new Vector3(s.pos3D.x * skeletonScale + skeletonX, s.pos3D.y * skeletonScale + skeletonY,
                    s.pos3D.z * skeletonScale + skeletonZ));
            sk.lineRenderer.SetPosition(1,
                new Vector3(e.pos3D.x * skeletonScale + skeletonX, e.pos3D.y * skeletonScale + skeletonY,

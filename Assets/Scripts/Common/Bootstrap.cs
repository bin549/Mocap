...
namespace Mediapipe.Unity.Sample {
    public class Bootstrap : MonoBehaviour {
        ...
        [Header("基本设置")] [SerializeField] private ImageSourceType _defaultImageSource;
        ...
        [Header("Glog 设置")] [SerializeField] private int _glogMinloglevel = Glog.Minloglevel;
        [SerializeField] private int _glogStderrthreshold = Glog.Stderrthreshold;
        [SerializeField] private int _glogV = Glog.V;

        [Header("WebCam 摄像头源")] [Tooltip("对于默认分辨率，将选择宽度最接近此值的分辨率")] [SerializeField]
        ...
        [Header("静态图像源")] [SerializeField] private Texture[] _availableStaticImageSources;
        ...
        [Header("视频源")] [SerializeField] private VideoClip[] _availableVideoSources;
        ...
        private IEnumerator Init() {
            Debug.Log(
                "The configuration for the sample app can be modified directly in the Bootstrap component inspector.");
      ...
      Debug.LogWarning("Logging for the MediaPipeUnityPlugin will be suppressed. To enable logging, please check the 'Development Build' option and build.");
            ...
            ImageSourceProvider.Initialize(
                BuildWebCamSource(), BuildVideoSource());

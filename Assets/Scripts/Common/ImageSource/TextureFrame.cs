...
#pragma warning restore IDE0065
    ...
    public class TextureFrame
    {
        ...
        private static readonly GlobalInstanceTable<Guid, TextureFrame> _InstanceTable =
            new GlobalInstanceTable<Guid, TextureFrame>(100);
 ...
 new GlTextureBuffer(GetTextureName(), width, height, gpuBufferformat, OnReleaseTextureFrame, glContext);
      return new GpuBuffer(glTextureBuffer);
        ...
        private Texture2D LoadToTextureBuffer(Texture texture)
        {
            ...
            var rect = new UnityEngine.Rect(0, 0, Mathf.Min(tmpRenderTexture.width, _textureBuffer.width),
                Mathf.Min(tmpRenderTexture.height, _textureBuffer.height));

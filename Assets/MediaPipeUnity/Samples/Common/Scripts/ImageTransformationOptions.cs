namespace Mediapipe.Unity.Sample
{
    ...
    {
        public static ImageTransformationOptions GetTransformationOptions(this ImageSource imageSource,
            bool expectedToBeMirrored = false)
        {
            var shouldFlipHorizontally =
                (imageSource.isFrontFacing || expectedToBeMirrored) ^ imageSource.isHorizontallyFlipped;
